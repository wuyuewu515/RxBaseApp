...
public class TitleBar extends FrameLayout {
    ...
    protected TitleBar initView(Context context, AttributeSet attrs) {
        titleView = LayoutInflater.from(context).inflate(getLayout(), this);
        ...
        if (attrs != null) {
            ...
            int leftIcon = taCustom.getResourceId(R.styleable.TitleBar_leftIcon, R.mipmap.back);
...
//        rlLayout.setBackgroundResource(backgroundColor);
    ...
    public TitleBar setTitlebar(String titleName) {
        return setTitlebar(R.mipmap.back, null, titleName, 0, null);
    }
