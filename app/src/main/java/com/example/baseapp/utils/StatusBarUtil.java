    ...
    public static void transparencyBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
         ...
         //   window.setStatusBarColor(Color.TRANSPARENT);
            window.setStatusBarColor(activity.getResources().getColor(R.color.bg_titlbar));
...
//        Log.e("flymeResult",result+"");
     ...
     * 根据手机类型区分
     */
    public static void statusBarColorByPhoneType(int phoneType, Activity context) {
        switch (phoneType) {
            case 0:// 不能设置黑色字体的手机
